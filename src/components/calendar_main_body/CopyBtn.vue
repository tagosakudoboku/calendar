    ...
    <div class="copy_btn">
        <button @click="click">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="width: 48px; height: 48px; opacity: 1;" xml:space="preserve">
                <g>
                    <rect x="115.774" y="335.487" class="st0" width="194.387" height="18.588" style="fill: #000000;"></rect>
                    <rect x="115.774" y="260.208" class="st0" width="194.387" height="18.527" style="fill: #000000;"></rect>
                    <rect x="115.774" y="184.862" class="st0" width="194.387" height="18.588" style="fill: #000000;"></rect>
                    <rect x="218.582" y="109.576" class="st0" width="91.58" height="18.588" style="fill: #000000;"></rect>
                    <path class="st0" d="M385.112,396.188V39.614c0-2.294-0.197-4.603-0.592-6.768C381.3,14.19,365.006,0,345.438,0H184.686
                        ...
                        C70.98,413.53,63.163,405.706,63.163,396.188z" style="fill: #000000;"></path>
                    <path class="st0" d="M431.488,76.205h-26.732l1.375,22.272h25.356c9.594,0,17.349,7.748,17.349,17.342v356.573
                        ...
                        c21.877,0,39.622-17.805,39.622-39.607V115.82C471.11,93.943,453.365,76.205,431.488,76.205z" style="fill: #000000;"></path>
                </g>
            </svg>
            <span>Copy</span>
        </button>
...
.copy_btn >button > span {
    font-weight: 950;
}

.copy_btn>button:hover {
    background-color: #0E83FD;
}
