            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="width: 64px; height: 64px; opacity: 1;" xml:space="preserve">
                <g>
                    <path class="st0" d="M89.016,138.656v13.5h39.063c28.516,0,58.266,7.219,82.828,19.5v-14.844
                        c-25.156-11.531-54.375-18.156-82.828-18.156H89.016z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M89.016,192.953v13.5h39.063c28.516,0,58.266,7.141,82.828,19.484v-14.906
                        c-25.156-11.531-54.375-18.078-82.828-18.078H89.016z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M89.016,247.188v13.5h39.063c28.516,0,58.266,7.219,82.828,19.547v-14.891
                        c-25.156-11.547-54.375-18.094-82.828-18.156H89.016z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M301.109,319.625v14.922c24.484-12.297,54.297-19.516,82.766-19.516H423v-13.469h-39.125
                        C355.469,301.563,326.266,308.156,301.109,319.625z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M89.016,301.484v13.484h39.063c28.516,0,58.266,7.219,82.828,19.516v-14.922
                        c-25.156-11.469-54.375-18.078-82.828-18.078H89.016z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M493.406,48.75h-97.5c-28.813,0.063-58.406,6.125-85.625,17.547c-20.781,8.719-39.016,19.922-54.297,33.359
                        ...
                        c13.797-15.031,32.531-27.719,53.531-36.625c22.531-9.641,47.563-15.063,71.594-15.063h82.375V377.25z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M301.109,156.875v14.844c24.484-12.281,54.297-19.5,82.766-19.5H423v-13.484h-39.125
                        C355.469,138.734,326.266,145.344,301.109,156.875z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M301.109,211.094v14.922c24.484-12.359,54.297-19.5,82.766-19.5H423v-13.484h-39.125
                        C355.469,193.031,326.266,199.563,301.109,211.094z" style="fill: rgb(75, 75, 75);"></path>
                    <path class="st0" d="M301.109,265.406v14.906c24.484-12.344,54.297-19.563,82.766-19.563H423v-13.5h-39.125
                        C355.469,247.328,326.266,253.875,301.109,265.406z" style="fill: rgb(75, 75, 75);"></path>
                </g>
            </svg>
        </span>
        <textarea cols="50" rows="4" v-model="description" @change="change"></textarea>
    </div>
</template>
